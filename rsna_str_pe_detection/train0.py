...
from rsna_str_pe_detection.augmentations import get_rsna_train_aug, get_rsna_valid_aug
from rsna_str_pe_detection.data import RsnaDS
...
class RsnaStrPeModule(pl.LightningModule):
    ...
    def configure_optimizers(self):
        opt = torch.optim.Adam(self.model.parameters(), lr=1e-3, weight_decay=5e-4)
    ...
    def train_dataloader(self):
        ...
        return DataLoader(train_dataset, sampler=sampler, batch_size=48, num_workers=6)

    def val_dataloader(self):
        aug = get_rsna_valid_aug('v0')
