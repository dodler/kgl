...
from albumentations import Compose, Normalize, Resize, CenterCrop, CLAHE, ShiftScaleRotate, RandomResizedCrop
from albumentations.pytorch import ToTensorV2
from pytorch_lightning.callbacks import EarlyStopping
from sklearn.metrics import roc_auc_score
from torch.optim.lr_scheduler import StepLR, CyclicLR, CosineAnnealingWarmRestarts, ExponentialLR
from torch.utils.data import DataLoader
from warmup_scheduler import GradualWarmupScheduler

from isic_melanoma.starter_512.data import MelanomaDataset
from isic_melanoma.starter_512.mel_models import get_mel_model
...
parser.add_argument('--sched', type=str, default='cyclic', choices=['cyclic', 'cosine_annealing_warm_restarts', 'exp'])
...
class MelanomaModule(pl.LightningModule):
    ...
    def train_dataloader(self):
        ...
        train_loader = DataLoader(train_ds, shuffle=True, num_workers=12, batch_size=self.batch_size)
        return train_loader
    ...
    def val_dataloader(self):
        ...
        valid_loader = DataLoader(valid_ds, shuffle=False, num_workers=12, batch_size=self.batch_size)
        return valid_loader
